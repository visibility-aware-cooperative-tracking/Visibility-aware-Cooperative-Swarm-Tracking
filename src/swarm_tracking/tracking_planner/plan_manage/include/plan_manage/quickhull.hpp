#ifndef MANAGE_CIRI_QUICKHULL_HPP
#define MANAGE_CIRI_QUICKHULL_HPP
...
template <typename T>
inline std::unique_ptr<std::vector<size_t>> manage_QuickHull<T>::getIndexVectorFromPool()
{
...
template <typename T>
inline void manage_QuickHull<T>::reclaimToIndexVectorPool(std::unique_ptr<std::vector<size_t>> &ptr)
{
...
template <typename T>
inline bool manage_QuickHull<T>::addPointToFace(typename MeshBuilder<T>::Face &f, size_t pointIndex)
{
